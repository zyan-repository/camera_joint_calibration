...
if __name__ == '__main__':
    ...
    img_dc = Image.open(folder + pic_file + '/20230216103447_pig_F0072-24_-1_-1_-1_-1_xw_white_small_stand_2116_orbbec_rgb.jpg')
    img_msx = Image.open(folder + pic_file + '/20230216103447_pig_F0072-24_-1_-1_-1_-1_xw_white_small_stand_2116_orbbec_depth.jpg')
