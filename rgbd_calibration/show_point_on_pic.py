...
def show_pic():
    folder = 'datasets/'
    suffix = 'a5fb6082-d435-47e3-9663-fc3f3d07c5c2'
    ...
    img_dc = Image.open(folder + suffix + '/20230215180449_pig_F0072-24_-1_-1_-1_-1_xw_white_small_stand_712_orbbec_rgb.jpg')
    img_msx = Image.open(folder + suffix + '/20230215180449_pig_F0072-24_-1_-1_-1_-1_xw_white_small_stand_712_orbbec_depth.jpg')
